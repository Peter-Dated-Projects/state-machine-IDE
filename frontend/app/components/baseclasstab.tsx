...
// supported languages
const SUPPORTED_LANGUAGES = ["python", "javascript", "typescript", "java", "csharp"];
...
export default function BaseClassTab() {
    ...
    <div className={styles.container}>
      <div className={styles["code-editor-container"]}>
        <div className={styles["code-editor-admin-bar"]}>
          <div style={{ display: "flex" }}>Base Class Code Editor</div>
          <div className={styles["code-editor-language-select"]} style={{ marginLeft: "auto" }}>
            <select
              value={baseClassLanguage}
              onChange={(e) => setBaseClassLanguage(e.target.value)}
